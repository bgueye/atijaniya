...
class FigureWorkFormScreen extends ConsumerStatefulWidget {
  const FigureWorkFormScreen(
      {super.key, required this.figureId, this.work, this.nextOrderIndex = 0});
  ...
  @override
  ConsumerState<FigureWorkFormScreen> createState() =>
      _FigureWorkFormScreenState();
}
...
class _FigureWorkFormScreenState extends ConsumerState<FigureWorkFormScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: Text(isEdit
              ? l10n.figureWorkFormEditTitle
              : l10n.figureWorkFormCreateTitle)),
            ...
            child: Column(
              ...
              children: [
                TextFormField(
                  ...
                  decoration:
                      InputDecoration(labelText: l10n.figureWorkFormTitleLabel),
                  validator: (value) => (value == null || value.trim().isEmpty)
                      ? l10n.figureWorkFormTitleRequired
                      : null,
                ),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      labelText: l10n.figureWorkFormDescriptionLabel),
                  maxLines: 4,
                ),
