        ...
        child: ListView(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(labelText: l10n.khadaraExternalUrlLabel),
              validator: (value) => (value == null || value.trim().isEmpty) ? l10n.khadaraExternalUrlRequired : null,
            ),
            const SizedBox(height: 20),
            FilledButton(
    ...
    return Opacity(
      ...
      child: Card(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: selected ? const BorderSide(color: AppColors.emerald, width: 2) : BorderSide.none,
        ),
        child: ListTile(
          leading: Icon(icon, color: selected ? AppColors.emerald : AppColors.bronze),
          title: Text(label),
          subtitle: subtitle != null ? Text(subtitle!, style: const TextStyle(fontSize: 12)) : null,
          trailing: selected ? const Icon(Icons.check_circle, color: AppColors.emerald) : null,
          onTap: onTap,
        ),
      ),
    );
